document.addEventListener('DOMContentLoaded', function() {
    ...
    const sections = document.querySelectorAll('.Info-section, .About-section, .Info-sectionm, .Projects-section, .Certificates-section, .contact-section'); // Añade todas tus secciones aquí
